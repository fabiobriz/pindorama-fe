        ...
        <div className="col-12 col-sm-12 col-md-6 col-lg-6 shadow rounded p-3">
            ...
            <div className="col-5 col-md-5 col-sm-5 col-lg-5 mx-auto text-break">
                ...
                <div className="col-6 col-md-6 col-sm-6 col-lg-6 mx-auto text-break">
                    ...
                    <p><MdAlternateEmail /> Pindorama@email.com</p>
                    <p><FaFacebook /> Facebook.com/Pindorama</p>
                    <p><FaTwitter /> Twitter.com/Pindorama</p>
                    <p><FaInstagram /> Instagram.com/Pindorama</p>
                </div>
            </div>
        </div>
    )
