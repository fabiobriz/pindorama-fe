...
import { buscarClienteIdUser, cancelarArtesanato } from '../../services/cliente.service';




function FormArtesanatoCL({ id, titulo }) {
    ...
    const CancelarArtesanato = async (e) => {
        ...
        if (userlogado !== undefined && userlogado.roles.includes("ROLE_CLIENTE")) {
            if (titulo === "Cancelar Artesanato" && id !== null) {
                            ...
                            <div className="form-group mb-3">
                                <div className="row">
                                    <div className="col-12 col-sm-12 col-md-12 col-lg-12 p-0">
                                        ...
                                        <textarea className="form-control bg-transparent btn-outline-warning" value={artesanato.descricao} readOnly={true} />
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default FormArtesanatoCL